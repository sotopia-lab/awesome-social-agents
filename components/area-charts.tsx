  ...
  render() {
    ...
    <div className='flex flex-col items-center justify-center'>
        <div className="flex flex-row gap-3 py-4">
            <Button variant="ghost" className={activeButton ==='Environment' ? "bg-teal-100 hover:bg-teal-200 font-bold dark:bg-teal-500" : "hover:bg-teal-200 font-bold"} onClick={() => this.handleButtonClick('Environment')}>Environment</Button>
